...
// Landsat 5 SR Imagery — 4 Classes (1995)
...
var startDate = '1995-06-01';
var endDate   = '1995-08-31';
...
//   TIP: For Riyadh 1995, Water is rare — focus on seasonal streams/reservoirs.
// ============================================================
...
Map.addLayer(classified.clip(aoi), classVis, 'LULC Classification — 1995');
...
Export.image.toDrive({
  ...
  description:    'LULC_Riyadh_1995_RF',
  folder:         'Riyadh',
  fileNamePrefix: 'LULC_Riyadh_1995_RF',
  region:         aoi,
  scale:          30,
  maxPixels:      1e13,
  crs:            'EPSG:4326'
...
// Export.image.toDrive({
//   image:          ndvi.clip(aoi),
//   description:    'NDVI_Riyadh_1995',
//   folder:         'Riyadh',
//   fileNamePrefix: 'NDVI_Riyadh_1995',
//   region:         aoi,
//   scale:          30,
//   maxPixels:      1e13,
//   crs:            'EPSG:4326'
